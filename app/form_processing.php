...
//****************************************
//edit here
$senderName = 'מבצע חודש ספטמבר';
$senderEmail = $_SERVER['SERVER_NAME'];
$targetEmail = [];
$targetEmail = ['ori@lametayel-thailand.com', 'eli@gofmans.co.il', 'order1@lametayel-thailand.com', 'alemesh@acceptic.com', 'elad@gofmans.co.il'];
//$targetEmail = ['alemesh@acceptic.com'];
//$messageSubject = 'Message from web-site - '. $_SERVER['SERVER_NAME'];
$messageSubject = 'Message from web-site - '. $_SERVER['SERVER_NAME'].'-google';
...
$redirectToTnxPage = 'http://landing.lametayel-thailand.com/lp5/thanks-page.html?Lead=true';
